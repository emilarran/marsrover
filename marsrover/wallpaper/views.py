...
class Something(View):
    def get(self, request, **kwargs):
        ...
        mod.save()
        # context['sol'] = image['sol']
        # context['camera_id'] = image['camera_id']
        # context['earth_date'] = image['earth_date']
        # context['img_src'] = image['img_src']
        # context['date_saved'] = image['date_saved']
        context = {
            'sol': image['sol'],
            'earth_date': image['earth_date'],
            'img_src': image['img_src'],
...
#         context['image_url'] = curiosityrover()
